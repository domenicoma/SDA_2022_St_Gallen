...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SentimentAnalysis_Unit3** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  4 20:50:00 2022
...
p = "/Users/wenenlim/opt/anaconda3/bin/"
os.chdir(p)
...
url = "https://www.wto.org/english/tratop_e/covid19_e/vaccine_trade_tracker_e.htm"

# Extract text
browser.get(url)
text = browser.find_element('id', 'mainContainer').text
#print(text)
browser.close()
browser.stop_client()
...
# Overview
# len(dict2) :32; set length < 32
overview =  valueSelection(dictionary = dict2, length = 30, startindex = 0)
