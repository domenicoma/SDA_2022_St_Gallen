...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  4 10:39:24 2022
...
path_to_file = "/Users/ValerieLai/Desktop/Smart Data Analytics/HW2_Valerie_Lai/"
...
url = "https://www.theguardian.com/world/2022/nov/04/russia-ukraine-war-at-a-glance-what-we-know-on-day-254-of-the-invasion"

# Extract text
browser.get(url)
text = browser.find_element('id', 'maincontent').text
#print(text)
browser.close()
browser.stop_client()
...
text_file = open("Ukraine war.txt", "w")
...
text = open(path.join(path_to_file, 'Ukraine war.txt')).read()
